import { SoblendBaileys, SoblendStorage, GroupAdminManager, MicroserviceBridge } from './index';

async function mainAdvanced() {
  console.log('🚀 Soblend Baileys - Advanced Features Demo');
  console.log('===========================================\n');

  const storage = new SoblendStorage('./bot_database', true, 'MySecurePassword123!');
  await storage.initialize();
  console.log('✅ Database initialized with encryption');

  const microservices = new MicroserviceBridge();
